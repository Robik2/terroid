...
namespace HealthAndStats {
    public class StatsManager : MonoBehaviour {
        [InfoBox("Leave all at 0 for player if not debugging")] [SerializeField]
